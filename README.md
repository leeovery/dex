...
- **Trust but verify** — periodically ask Claude to "run a lint": broken links,
  uncited items, stale pages, and contradictions get found and fixed. Corrections
  you make by hand are pinned and survive every rebuild.
